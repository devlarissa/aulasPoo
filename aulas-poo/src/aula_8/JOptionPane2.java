...
//		JOptionPane.showMessageDialog(null, "Digite sua idade: ", "Olá " + nome ,JOptionPane.QUESTION_MESSAGE);
		String idade = JOptionPane.showInputDialog("Digite sua idade: ");
		
		JOptionPane.showMessageDialog(null, "Olá " + nome + " sua idade é " + idade, "Aperte ok para fechar!",JOptionPane.INFORMATION_MESSAGE);
